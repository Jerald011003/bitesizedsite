...
export const listPlans = (keyword = '') => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://bitesizedsite.pythonanywhere.com/api/songs${keyword}`)
...
export const listTopPlans = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://bitesizedsite.pythonanywhere.com/api/plans/top/`)
...
export const listPlanDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://bitesizedsite.pythonanywhere.com/api/plans/${id}`)
...
export const deletePlan = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete(
            `https://bitesizedsite.pythonanywhere.com/api/plans/delete/${id}/`,
            config
        )
...
export const createPlan = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(
            `https://bitesizedsite.pythonanywhere.com/api/plans/create/`,
            {},
            config
        )
        dispatch({
...
export const updatePlan = (plan) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(
            `https://bitesizedsite.pythonanywhere.com/api/plans/update/${plan._id}/`,
            plan,
            config
        )
        dispatch({
...
export const createPlanReview = (planId, review) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(
            `https://bitesizedsite.pythonanywhere.com/api/plans/${planId}/reviews/`,
            review,
            config
        )
        dispatch({
